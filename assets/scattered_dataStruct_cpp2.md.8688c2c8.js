import{_ as c,o as i,c as o,z as s,a as n,t,G as l,B as p,V as a,D as b}from"./chunks/framework.055571f3.js";const R=JSON.parse('{"title":"简单再次复习一下 C++","description":"","frontmatter":{"title":"简单再次复习一下 C++"},"headers":[],"relativePath":"scattered/dataStruct/cpp2.md","filePath":"scattered/dataStruct/cpp2.md","lastUpdated":1686207654000}'),u={name:"scattered/dataStruct/cpp2.md"},m={id:"frontmatter-title",tabindex:"-1"},d=s("img",{src:"https://gaidocs.oss-cn-hangzhou.aliyuncs.com/intenet/202305171013458.png",width:"46",height:"46",alt:"图片描述",style:{display:"inline","margin-bottom":"-6px"}},null,-1),y=s("a",{class:"header-anchor",href:"#frontmatter-title","aria-label":'Permalink to "{{$frontmatter.title}} <img src="https://gaidocs.oss-cn-hangzhou.aliyuncs.com/intenet/202305171013458.png" width="46" height="46" alt="图片描述" style="display:inline; margin-bottom: -6px"/>"'},"​",-1),h=a(`<h1 id="基础" tabindex="-1">基础 <a class="header-anchor" href="#基础" aria-label="Permalink to &quot;基础&quot;">​</a></h1><h2 id="函数" tabindex="-1">函数 <a class="header-anchor" href="#函数" aria-label="Permalink to &quot;函数&quot;">​</a></h2><div class="tip custom-block"><p class="custom-block-title">TIP</p><p>概念：能够实现特定功能的程序模块。</p><p>程序是有函数组成的，一个函数就是程序中的一个模块。函数可以相互调用，可以将相互联系密切的语句都放在一个函数内，也可以将负责的函数分解成多个子函数。</p></div><h3 id="函数概述" tabindex="-1">函数概述 <a class="header-anchor" href="#函数概述" aria-label="Permalink to &quot;函数概述&quot;">​</a></h3><ol><li><p>函数的定义</p><div class="language-c++ line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">c++</span><pre class="shiki github-dark"><code><span class="line"><span style="color:#e1e4e8;">类型标识符 函数名(形式参数列表)</span></span>
...
<span class="line"><span style="color:#e1e4e8;">    char name[30];</span></span>
<span class="line"><span style="color:#e1e4e8;">    short age;</span></span>
<span class="line"><span style="color:#e1e4e8;">}*pPersonInfo;</span></span></code></pre><div class="line-numbers-wrapper" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br></div></div>`,8),w=a(`<p>如果要引用指针结构体变量的成员，需要使用指向运算符“-&gt;”</p><p>形式：<code>结构体指针变量 -&gt; 成员名</code></p><p>例如：</p><div class="language-c++ line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">c++</span><pre class="shiki github-dark"><code><span class="line"><span style="color:#e1e4e8;">pPersonInfo -&gt; index;</span></span>
